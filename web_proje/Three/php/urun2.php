...
<div class="orta kapsayici">
    <div class="bolum4 urun">
        <a href ="/web_proje/Three/html/genshin.html">
        <img src="/web_proje/jpg/genshin.jpg" alt="Kapak resmi"  height="350">
        </a>
       <div class=urun_bilgi >
            <h1>Ürün adı: Genshin Impact karakter figürü</h1>
            <h1>Ürün fiyatı: 2000 TL</h1>
            <h1>Kalan ürün adeti:
             <?php 
             $baglanti = mysqli_connect($host, $kullanici, $password, $vt);
