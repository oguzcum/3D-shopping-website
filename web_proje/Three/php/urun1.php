...
<div class="orta kapsayici">
    <div class="bolum4 urun">
        <a href="/web_proje/Three/html/falcon.html">
        <img src="/web_proje/jpg/millennium_falcon.jpg" alt="Kapak resmi"  height="350">
        </a>
       <div class=urun_bilgi >
            <h1>Ürün adı: Millennium Falcon Lego figürü</h1>
            <h1>Ürün fiyatı: 2500 TL</h1>
            <h1>Kalan ürün adeti:
             <?php 
             $baglanti = mysqli_connect($host, $kullanici, $password, $vt);
