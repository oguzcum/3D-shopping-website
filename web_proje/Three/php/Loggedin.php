...
<div class="orta kapsayici">
    <div class="bolum1">
        <img src="/web_proje/jpg/indirim.jpg" alt="Kapak resmi"  height="350">
    </div>
</div>
...
<div class="orta kapsayici">
    ...
    <div class="urunkarti">
        <a href="urun1.php"> <img src="/web_proje/jpg/millennium_falcon.jpg" alt="urun" >  </a>
            
        </div>
        <div class="urunkarti">
            <a href="urun2.php"> <img src="/web_proje/jpg/genshin.jpg" alt="urun"  > </a>
            
        </div>
        <div class="urunkarti">
            <a href="urun3.php"> <img src="/web_proje/jpg/Porsche_911.jpg" alt="urun"  > </a>
        </div>
        <div class="urunkarti">
        <a href="urun1.php"> <img src="/web_proje/jpg/millennium_falcon.jpg" alt="urun" >  </a>
